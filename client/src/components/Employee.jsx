const Employee = ({ id, name, age, dept, salary, onDelete , onEdit}) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col transition hover:shadow-md">
      ...
      <div className="flex justify-between mt-5">
        <button
          className="bg-green-500 hover:bg-green-600 text-white text-sm font-medium px-8 py-2.5 rounded-lg transition w-fit cursor-pointer"
          onClick={onEdit}
        >
          Update
        </button>
